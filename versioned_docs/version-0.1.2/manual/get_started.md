...
Rsvim is developed by the [rsvim](https://github.com/rsvim-editor/) community. The project is hosted on [GitHub](https://github.com/rsvim-editor/rsvim), with documentation available on [GitHub Pages](https://rsvim.pages.dev/). Both are licensed under [Vim License](https://github.com/rsvim/rsvim/blob/main/LICENSE.txt) in accordance with the [Vim](https://github.com/vim/vim) project.
